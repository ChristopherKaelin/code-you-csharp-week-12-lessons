...
class Program
{
    static async Task Main()
    {
        ...
        Console.WriteLine("");
        Console.WriteLine($"Performance baseline: time taken to return to Main: {timeTakenToReturn.TotalSeconds} seconds");
        ...
        Console.WriteLine("Implement File I/O tasks asynchronously.");
        ...
        Console.WriteLine($"Time taken to return to Main: {(timeAfterAsyncLoadCall - timeBeforeAsyncLoadCall).TotalSeconds} seconds");
        ...
        Console.WriteLine("Implement File I/O tasks asynchronously and in parallel.");
        ...
        Console.WriteLine($"Time taken to return to Main: {(timeAfterAsyncParallelLoadCall - timeBeforeAsyncParallelLoadCall).TotalSeconds} seconds");
